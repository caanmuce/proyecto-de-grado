                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="index.php" method="post" class="user">
                                        ...
                                        <button type="submit" name="btnIngresar" class="btn btn-primary btn-user btn-block">Ingresar</button>
                                        <a href="">¿Olvidaste tu contraseña?</a>  |  <a href="registrar.php">¿No tienes cuenta?</a>
